...
class Test(unittest.TestCase):
    def test01(self):
        ...
        hostname='https://camel.test.druidtech.net'
        r = requests.get('https://camel.test.druidtech.net',verify=False)
        print(r.status_code)
        print(r.headers)
        ...
        #post登录请求
        login1 = requests.post('https://camel.test.druidtech.net/api/v1/login',uspw_data1,verify=False)
        ...
        change1=requests.put('https://camel.test.druidtech.net/api/v1/user/password',passworddata1,headers=header1,verify=False)
        ...
        #post登录请求
        login2 = requests.post('https://camel.test.druidtech.net/api/v1/login',uspw_data2,verify=False)
        ...
        change2=requests.put('https://camel.test.druidtech.net/api/v1/user/password',passworddata2,headers=header2,verify=False)
        print("status",change2.status_code)
        print(change2.text)

        #post登录请求
        login3 = requests.post('https://camel.test.druidtech.net/api/v1/login',uspw_data1,verify=False)
        ...
        header = {
            ...
            "User-Agent": "Apache-HttpClient/4.5.5 (Java/1.8.0_144)"}
        #getmyself
        getmyself = requests.get('https://camel.test.druidtech.net/api/v1/user/myself',headers=header,verify=False)
        ...
        info = requests.put('https://camel.test.druidtech.net/api/v1/user/info',upuserinfo,headers=header,verify=False)
        #断言返回状态码
        ...
        #getcompany
        getcompany = requests.get('https://camel.test.druidtech.net/api/v1/company/',headers=header,verify=False)
        print(getcompany.status_code)
        self.assertEquals(getcompany.status_code,200)
        self.assertIn(u"测试设备的",getcompany.text)

        #getDevices
        getdevices = requests.get('https://camel.test.druidtech.net/api/v1/device/',headers=header,verify=False)
        print("devices",getdevices.text)
        self.assertIn("598a72b10059ea0a3107e1b9",getdevices.text)
        #正则表达式获取Deviceid
        ...
        #GET Device By ID
        getbyid = requests.get('https://camel.test.druidtech.net/api/v1/device/id/'+deviceid,headers=header,verify=False)
        ...
        #Get Device By UUID
        getbyuuid = requests.get('https://camel.test.druidtech.net/api/v1/device/uuid/'+deviceuuid,headers=header,verify=False)
        self.assertIn("id",getbyuuid.text)

        #GET Area By DeivceID
        getarea = requests.get('https://camel.test.druidtech.net/api/v1/device/id/'+deviceid+'/area',headers=header,verify=False)
        self.assertEquals(200,getarea.status_code)
        print(getarea.text)

        #Search Device By mark
        searchbymark = requests.get('https://camel.test.druidtech.net/api/v1/device/search/mark/'+devicemark,headers=header,verify=False)
        self.assertEquals(200,searchbymark.status_code)
        print(searchbymark.text)

        #GET Room Is idle
        getroom = requests.get('https://camel.test.druidtech.net/api/v1/device/idle/room',headers=header,verify=False)
	...
	"id":[
        ...
        listmany = requests.post('https://camel.test.druidtech.net/api/v1/device/many',idjs,headers=header,verify=False)
        self.assertEquals(200,listmany.status_code)
        print("listmany",listmany.text)
        self.assertIn("firmware_version",listmany.text)
        #根据返回的listmany.text获取各种信息，为Update camel Info By DeviceID准备
        #获取owner_id
        ...
        regsier = requests.post('https://camel.test.druidtech.net/api/v1/device/many',redata,headers=header,verify=False)
    ...
    deviceid
        ...
        exclude = requests.post('https://camel.test.druidtech.net/api/v1/device/exclude',exid,headers=header,verify=False)
        print("exclude",exclude.status_code)
        self.assertIn("uuid",exclude.text)
        self.assertEquals(200,exclude.status_code)

        #Get Device GPS
        getgps = requests.get('https://camel.test.druidtech.net/api/v1/gps/device/'+deviceid,headers=header,verify=False)
        self.assertEquals(200,getgps.status_code)
        print("gps",getgps.text)

        #Get Device Behavior
        getbehavior = requests.get('https://camel.test.druidtech.net/api/v1/behavior/device/'+deviceid,headers=header,verify=False)
        ...
        getanalyze = requests.post('https://camel.test.druidtech.net/api/v1/behavior/analyze/',analyzedata,headers=header,verify=False)
        ...
        getodba=requests.post('https://camel.test.druidtech.net/api/v1/odba/analyze/',odbadata,headers=header,verify=False)
...
"species": -1
        ...
        getloving=requests.post('https://camel.test.druidtech.net/api/v1/odba/loving/',lovingdata,headers=header,verify=False)
        self.assertEqual(200,getloving.status_code)
        '''

        #Search Device
        #searchdevice=requests.post('https://camel.test.druidtech.net/api/v1/search/device/',headers=header,verify=False)
        ...
        createarea=requests.post('https://camel.test.druidtech.net/api/v1/ditu/',areadata,headers=header,verify=False)
        ...
        #Add Device to Area
        adddevicetoarea = requests.put('https://camel.test.druidtech.net/api/v1/ditu/area/'+areaid+'/adddevice/'+deviceid,headers=header,verify=False)
        ...
        #List Area
        listarea = requests.get('https://camel.test.druidtech.net/api/v1/ditu/area',headers=header,verify=False)
        ...
        updatearea=requests.put('https://camel.test.druidtech.net/api/v1/ditu/area/'+areaid,areainfodata,headers=header,verify=False)
        #self.assertEqual(200,updatearea.status_code)
        self.assertIn("Connection",updatearea.headers)

        #Get Area info with ID
        getareainfo=requests.get('https://camel.test.druidtech.net/api/v1/ditu/area/'+areaid,headers=header,verify=False)
        self.assertIn(areaid,getareainfo.text)
        self.assertEqual(200,getareainfo.status_code)

        #Delete Area
        deletearea=requests.delete('https://camel.test.druidtech.net/api/v1/ditu/area/'+areaid,headers=header,verify=False)
	...
	"room_name":"分组2"
        ...
        createroom=requests.post('https://camel.test.druidtech.net/api/v1/room/',roomdata,headers=header,verify=False)
   ...
   "id":[
        ...
        print(adddata)
        adddevicetoroom=requests.put('https://camel.test.druidtech.net/api/v1/room/id/'+roomid+'/adddevice',adddata,headers=header,verify=False)
        self.assertEquals(201,adddevicetoroom.status_code)

        #Get Device in Room
        getdeviceinroom=requests.get('https://camel.test.druidtech.net/api/v1/room/id/'+roomid+'/device',headers=header,verify=False)
        ...
        deletefromroom=requests.put('https://camel.test.druidtech.net/api/v1/room/id/'+roomid+'/deldevice',deletedata,headers=header,verify=False)
	...
	"room_name":"分组3"
        ...
        updateroom=requests.put('https://camel.test.druidtech.net/api/v1/room/id/'+roomid,roominfodata,headers=header,verify=False)
        self.assertEquals(201,updateroom.status_code)

        #List Room
        lisroom=requests.get('https://camel.test.druidtech.net/api/v1/room/',headers=header,verify=False)
        self.assertIn(roomid,lisroom.text)

        #Get Room info
        getroominfo=requests.get('https://camel.test.druidtech.net/api/v1/room/id/'+roomid+'/info',headers=header,verify=False)
        self.assertIn(roomid,getroominfo.text)

        #Delete Room
        deleteroom=requests.delete('https://camel.test.druidtech.net/api/v1/room/id/'+roomid,headers=header,verify=False)
        self.assertEquals(204,deleteroom.status_code)

        #Update camel Info By DeviceID
        #处理数据的引号？
        camelinfo={
    "device_id": "598a72b10059ea0a3107e1b9",
    "owner_id": "5acb2bbee02149026307dd7d",
    ...
    "species": ""
        ...
        cameldata=json.dumps(camelinfo)
        print("cameldata",cameldata)
        updatecamel=requests.put('https://camel.test.druidtech.net/api/v1/biological/camel/device/'+deviceid,cameldata,headers=header,verify=False)
        print(updatecamel.status_code)
        print("updatecamel.text",updatecamel.text)
	...
	"id":[
        ...
        listmany2 = requests.post('https://camel.test.druidtech.net/api/v1/device/many',idjs2,headers=header,verify=False)
        self.assertEquals(200,listmany2.status_code)
        print("listmany",listmany2.text)
        self.assertIn("firmware_version",listmany2.text)
        '''
        #GET Device By ID
        getbyid2 = requests.get('https://camel.test.druidtech.net/api/v1/device/id/'+deviceid,headers=header,verify=False)
        #获取image
        strim2=str(getbyid2.text)
        ...
        #Get image
        getimage=requests.get('https://camel.test.druidtech.net/api/v1/file/device/'+deviceid+'/image/'+imageid,headers=header,verify=False)
        self.assertEquals(200,getimage.status_code)

        #Get thumbnail Images 缩略图
        getthumbnail=requests.get('https://camel.test.druidtech.net/api/v1/file/device/'+deviceid+'/image/'+imageid+'/thumbnail',headers=header,verify=False)
        print("getthumbnail url: ",'https://camel.test.druidtech.net/api/v1/file/device/'+deviceid+'/image/'+imageid+'/thumbnail')
        self.assertEquals(200,getthumbnail.status_code)

        #Get camel By DeviceId
        getbydeviceid=requests.get('https://camel.test.druidtech.net/api/v1/biological/camel/device/'+deviceid,headers=header,verify=False)
        ...
        #deletimage=requests.delete('https://camel.test.druidtech.net/api/v1/biological/camel/id/'+biologicalid+'/image/'+imageid,headers=header,verify=False)
        #print("deletimage url:",'https://camel.test.druidtech.net/api/v1/biological/camel/id/'+biologicalid+'/image/'+imageid)
        #self.assertEquals(200,deletimage.status_code)
        #删除图片 暂时代替
        deleteimagebydevice2=requests.delete('https://camel.test.druidtech.net/api/v1/biological/camel/device/'+deviceid+'/image/'+imageid,headers=header,verify=False)
        print("deleteimagebydevice url: ",'https://camel.test.druidtech.net/api/v1/biological/camel/device/'+deviceid+'/image/'+imageid)
        ...
        #GET Device By ID
        getbyid3 = requests.get('https://camel.test.druidtech.net/api/v1/device/id/'+deviceid,headers=header,verify=False)
        #获取imageid
        strim3=str(getbyid3.text)
        ...
        putmessage=requests.put('https://camel.test.druidtech.net/api/v1/message/',putdata,headers=header,verify=False)
        self.assertEquals(201,putmessage.status_code)

        #Delete message
        deletemessage=requests.delete('https://camel.test.druidtech.net/api/v1/message/id/'+unreadmessageid,headers=header,verify=False)
        self.assertEquals(204,deletemessage.status_code)
        #Get Unread Message
        getunreadmessage2=requests.get('https://camel.test.druidtech.net/api/v1/message/unread',headers=header,verify=False)
        #unreadmessageid
